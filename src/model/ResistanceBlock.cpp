...
void ResistanceBlock::setup_dofs(DOFHandler &dofhandler) {
  Block::setup_dofs_(dofhandler, 2, {});
}

void ResistanceBlock::update_constant(SparseSystem &system,
...
void ResistanceBlock::update_solution(
...
void ResistanceBlock::update_gradient(
