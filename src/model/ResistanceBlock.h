...
/**
 * @file ResistanceBlock.h
 * @brief model::ResistanceBlock source file
 */
#ifndef SVZERODSOLVER_MODEL_RESISTANCEBLOCK_HPP_
#define SVZERODSOLVER_MODEL_RESISTANCEBLOCK_HPP_
...
/**
 * @brief Resistance block
 *
 * Models the mechanical behavior of a resistance block.
 *
 * \f[
 ...
 *
 */
class ResistanceBlock : public Block {
 public:
  /**
  ...
  /**
   * @brief Construct a new ResistanceBlock object
   *
   * @param id Global ID of the block
   * @param model The model to which the block belongs
   */
  ResistanceBlock(int id, Model *model)
      : Block(id, model, BlockType::resistance_block, BlockClass::vessel,
              {{"R", InputParameter()}}) {}
...
#endif  // SVZERODSOLVER_MODEL_RESISTANCEBLOCK_HPP_
